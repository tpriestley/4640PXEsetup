...
scp -i ~/.ssh/acit_admin_id_rsa -P 9222 admin@localhost:${SETUP_FOLDER}/ks.cfg -P 8022 admin@localhost:/www/
scp -i ~/.ssh/acit_admin_id_rsa -P 9222 admin@localhost:${SETUP_FOLDER}/setup/install_script.sh -P 8022 admin@localhost:/www/
scp -i ~/.ssh/acit_admin_id_rsa -P 9222 -r admin@localhost:${SETUP_FOLDER}/setup/ -P 8022 admin@localhost:/home/admin/
